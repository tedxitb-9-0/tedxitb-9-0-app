...
export default function AboutHero() {
  return (
    <PlainBackground color="red">
      <div className="my-20 flex min-h-screen items-center justify-center pt-16 md:py-20">
        <motion.div
        ...
        >
          ...
          <div className="mt-3 grid w-full grid-cols-1 gap-6 md:grid-cols-2">
            <motion.div
            ...
            >
              <h3 className="text-red mb-3 text-2xl font-extrabold md:text-3xl">
                What does TED stand for?
              </h3>
              <p className="text-foreground/90 text-justify text-sm leading-5 md:text-base md:leading-7">
                TED stands for Technology, Entertainment, Design — three broad
                subject areas that are collectively shaping our world. But a TED
                conference is broader still, showcasing important research and
                ideas from all disciplines and exploring how they connect. The
                goal is to expand the imagination, make unexpected connections,
                inspire conversation and set the ball in motion for meaningful
                learning and change.
              </p>
            </motion.div>

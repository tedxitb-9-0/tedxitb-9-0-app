    ...
    return (
        <div className="relative container mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-between gap-12 px-4 pt-32 pb-16 lg:flex-row">
            ...
            >
                ...
                >
                    A journey from chaos to calm, from simply seeing colors to
                    truly feeling and understanding them, TEDXpressive invites
                    you to explore happiness in a deeper way. It is not just a
                    workshop or an exhibition, but a story you walk through.
                    See, feel, create, and share, and leave with your own
                    Happiness Palette and a story told in colors.{" "}
                </motion.p>
            </motion.div>

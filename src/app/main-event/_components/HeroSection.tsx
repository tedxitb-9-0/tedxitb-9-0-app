...
const HeroSection = () => {
  return (
    <div className="relative container mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-between gap-12 px-4 pt-32 pb-16 lg:flex-row">
      ...
      >
        <Image
          src="/main-event/bottom-asset.png"
          alt="Decorative geometric pattern"
          width={1800}
          height={500}
          className="h-auto w-full"
      ...
      >
        ...
        >
          <Image
            src="/main-event/tedxpressive.png"
            width={600}
            height={150}
            alt="TEDxpressive"
        ...
        >
          ...
          world in new ways, while interactive experiences bring the theme of
          happiness through color to life. Move freely between lively exchanges
          and quieter reflections, then immerse yourself in the Color Sanctuary,
          a space of shifting moods, and curated moments to pause, recharge, and
          reconnect. Mark your calendar and come with an open mind, ready to
          explore a dynamic journey of stories, perspectives, and shared
          experiences.
        </motion.p>
      </motion.div>
      ...
      >
        ...
        >
          <Image
            src="/main-event/hero-asset.png"
            width={2000}
            height={2000}
            alt="Main Event Hero Asset"

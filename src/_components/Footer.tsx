...
export default function Footer() {
  return (
    <footer className="w-full text-black">
      <div className="flex flex-col items-center justify-around gap-8 px-6 py-8 md:flex-row md:items-start md:px-12">
        <motion.div
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:justify-start">
            <Link
              href="https://instagram.com/tedxitb"
        ...
        >
          <div className="flex flex-col gap-2 text-center md:text-left">
            ...
            <Link href="/main-event" className="hover:opacity-70">
              Main Event
            </Link>
            <Link href="/pre-event" className="hover:opacity-70">
              Pre-Event
            </Link>
          </div>
          <div className="flex flex-col gap-2 text-center md:text-left">
            <Link href="/merchandise" className="hover:opacity-70">
              Merchandise
            </Link>
            <Link href="/magazine" className="hover:opacity-70">
              Magazine
            </Link>
            <Link href="/sponsorship" className="hover:opacity-70">
              Sponsorships
            </Link>
          </div>
        </motion.div>

            ...
            <Link href="/main-event">
              <button className="flex items-center gap-2 rounded-lg bg-white px-6 py-2 text-sm font-semibold text-red-600 shadow-md transition-colors hover:cursor-pointer hover:bg-gray-100">
                ...
                <motion.div
                    ...
                    style={{
                        background:
                            "linear-gradient(to bottom right, #FF6A15, #FF975C)",
                    }}
                >
                    <div className="mb-3 flex items-center justify-between gap-2 md:mb-4 md:gap-3">
                        <div>
                    ...
                    <p className="mb-4 text-justify text-xs leading-relaxed text-white md:mb-6 md:text-sm">
                        TEDxITB is an independent, locally licensed TED event
                        held at the Bandung Institute of Technology
                    </p>
                    <div className="flex justify-end">
                        <Link href="/about">
                ...
                >
                    ...
                    <p className="mb-4 text-justify text-xs leading-relaxed text-white md:mb-6 md:text-sm">
                        A journey from chaos to calm, from simply seeing colors
                        to truly feeling and understanding them, TEDXpressive
                        invites you to explore happiness in a deeper way.{" "}
                    </p>
                    <div className="flex justify-end">
                        <Link href="/pre-event">

...
export default function ColorfulBackground({
    ...
    return (
        <section
            ref={containerRef}
            className={`relative z-0 flex h-fit min-h-screen w-full flex-col items-center justify-center gap-4 overflow-hidden select-none ${className}`}
        >
            {/* Background image - optimized with Next.js Image */}
            <Image
                src="/colorfulbg/colorfulbg.webp"
                alt=""
                fill
                priority={priority}
            ...
            >
                <Image
                    src="/colorfulbg/rightasset.webp"
                    alt="Decorative geometric pattern"
                    width={400}
                    height={400}
